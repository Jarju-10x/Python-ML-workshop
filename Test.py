...
p_model = pickle.load(open('C:/Users/iibm/Desktop/ML-workshop/pa.sav','rb') )
...
if (selected == 'Transformer Health Prediction'):
    ...
    with col1:
        Hydrogen = st.text_input('Hydrogen Level')
        
    with col2:
        Oxigen = st.text_input('Oxigen Level')
    
    with col3:
        Nitrogen = st.text_input('Nitrogen Level')
    
    with col1:
        Methane = st.text_input('Mathane Level')
    
    with col2:
        CO = st.text_input('CO Level')
    
    with col3:
        CO2 = st.text_input('CO2 value')
    
    with col1:
        Ethylene = st.text_input('Ethylene Level')
    
    with col2:
        Ethane= st.text_input('Ethane Level')
    
    with col3:
        Acethylene = st.text_input('Acethylene Level')
        
    with col1:
        DBDS = st.text_input('DBDS Level')
    
    with col2:
        PF= st.text_input('Power factor Value')
    
    with col3:
        IV= st.text_input('Interfacial V')
    
    with col1:
        DR= st.text_input('Dielectric rigidity Value')
    
    with col2:
        WC= st.text_input('Water content')    
